  ...
  async request(req) {
    ...
    for (let i = 0; i <= this.retry.attempts; i++) {
      try {
        ...
        if (((_a = requestOptions.signal) == null ? void 0 : _a.aborted) && isSignalFunction) {
          throw error_;
        } else if ((_b = requestOptions.signal) == null ? void 0 : _b.aborted) {
...
var Pipeline = class {
  constructor(opts) {
     ...
     */
    __publicField(this, "hmset", (key, kv2) => this.chain(new HMSetCommand([key, kv2], this.commandOptions)));
    /**
     ...
     */
    __publicField(this, "hset", (key, kv2) => this.chain(new HSetCommand([key, kv2], this.commandOptions)));
    /**
     ...
     */
    __publicField(this, "mset", (kv2) => this.chain(new MSetCommand([kv2], this.commandOptions)));
    /**
     * @see https://redis.io/commands/msetnx
     */
    __publicField(this, "msetnx", (kv2) => this.chain(new MSetNXCommand([kv2], this.commandOptions)));
    /**
  ...
  handleMessage(data, isPattern) {
    ...
    if (firstCommaIndex !== -1 && secondCommaIndex !== -1) {
      ...
      if (isPattern && type === "pmessage" && thirdCommaIndex !== -1) {
        ...
        try {
          const message = ((_a = this.opts) == null ? void 0 : _a.automaticDeserialization) === false ? messageStr : JSON.parse(messageStr);
        ...
        try {
          if (type === "subscribe" || type === "psubscribe" || type === "unsubscribe" || type === "punsubscribe") {
            ...
            const message = ((_b = this.opts) == null ? void 0 : _b.automaticDeserialization) === false ? messageStr : parseWithTryCatch(messageStr);
...
var Redis = class {
  ...
  constructor(client, opts) {
     ...
     * @see https://redis.io/commands/hmset
     */
    __publicField(this, "hmset", (key, kv2) => new HMSetCommand([key, kv2], this.opts).exec(this.client));
    /**
     * @see https://redis.io/commands/hrandfield
     */
     ...
     * @see https://redis.io/commands/hset
     */
    __publicField(this, "hset", (key, kv2) => new HSetCommand([key, kv2], this.opts).exec(this.client));
    /**
     * @see https://redis.io/commands/hsetnx
     */
     ...
     * @see https://redis.io/commands/mset
     */
    __publicField(this, "mset", (kv2) => new MSetCommand([kv2], this.opts).exec(this.client));
    /**
     * @see https://redis.io/commands/msetnx
     */
    __publicField(this, "msetnx", (kv2) => new MSetNXCommand([kv2], this.opts).exec(this.client));
    /**
     * @see https://redis.io/commands/persist
     */
...
// node_modules/.pnpm/@vercel+kv@3.0.0/node_modules/@vercel/kv/dist/index.js
var _kv = null;
